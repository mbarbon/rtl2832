...
=================================================================================================================
rc function use 
1.After Version 2.0,0 the driver can support rc function 
2.modify "RTL2832U_REMOTE_CONTROL_ENABLE" define	
  if define "RTL2832U_REMOTE_CONTROL_ENABLE= 0x01"  enable  rc function
  if define "RTL2832U_REMOTE_CONTROL_ENABLE= 0x00"  disable rc function	
3.modify "RT_use_rc_protocol" to select rc protocol
  	if define RT_use_rc_protocol   0     use RC6 protocol
	if define RT_use_rc_protocol   1     use RC5 protocol
	if define RT_use_rc_protocol   2     use nec protocol
4.to edit KEY_MAP, KEY_MAP is define in "rtl2832u_rc_keys_map_table"   	
5.If any problems or view rc scancode, please set the parameter "debug=3" to show debug messages or scan code 
  ,when driver is probed, and send "/var/log/messages" file to us. 